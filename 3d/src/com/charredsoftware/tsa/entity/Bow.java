...
public class Bow {
	...
	public boolean UPGRADE_LARGER_RADIUS = true, UPGRADE_MORE_DAMAGE = true, UPGRADE_CONTINUOUS_DAMAGE, UPGRADE_FURTHER_SHOTS = true, UPGRADE_INCREASED_ACCURACY = true;
